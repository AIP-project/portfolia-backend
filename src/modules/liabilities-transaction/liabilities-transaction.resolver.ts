...
import { LiabilitiesTransaction, LiabilitiesTransactions } from "./models"
...
export class LiabilitiesTransactionResolver {
  ...
  async resolveRepaymentDate(@Parent() liabilitiesTransaction: LiabilitiesTransaction) {
    return parseISOString(liabilitiesTransaction.repaymentDate)
  }
}
